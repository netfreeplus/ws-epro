...
echo -e "$bar1"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "${rojo}#    ${verde}Bienvenido${blanco}, Gracias por utilizar TOKEN ID By: NETCOLVIP ${guinda}https://t.me/NETCOLVIP   ${rojo}# ${cierre}"
    ...
    echo -e "${rojo}#          ${blanco}dev: ${moradoL}@NETCOLVIP ${blanco}- ${verdeR}NETCOL ${amarillo}VIP${cierre}           ${rojo}#${cierre}"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "$bar1"
}
...
crear () {
    clear
    TITLE="${blanco}NETCOL ${verdeR}VIP"
echo -e "$TITLE"
echo -e ""
...
echo -e "\e[32m  Puerto Bad-vpm: \e[0m"$badvpn-ud
echo -e "\e[32m  Puerto SSL: \e[0m"$stunnel4
echo -e "\e[32m  Puertos Squid: \e[0m"$squidport
echo -e "\e[32m  Puertos Openvpn: \e[0m"$openvpnport
echo -e "\e[32m  Puertos python: \e[0m"$python
echo -e "$bar1"
fi
}
#ELIMINAR ID
